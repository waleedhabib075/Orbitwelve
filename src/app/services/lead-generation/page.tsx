				...
				<div className="mx-auto max-w-7xl px-6 lg:px-8">
					<div className="mx-auto max-w-4xl">
						...
						<div className="text-gray-700 leading-relaxed space-y-4 text-center mb-12">
							<p>
								We combine automation, analytics, and creative funnels to attract qualified leads. Orbitwelve's targeted campaigns across multiple channels ensure you connect with decision-makers and grow your customer base efficiently. Our data-driven approach identifies high-value prospects and nurtures them through personalized engagement strategies.
							</p>
						</div>
						...
						<div className="grid grid-cols-3 md:grid-cols-6 gap-8 mb-12 justify-items-center">
							...
							<div className="flex flex-col items-center">
								<div className="w-20 h-20 bg-white rounded-lg shadow-sm p-3 flex items-center justify-center mb-2">
									<Image src="/placeholder-icon.png" alt="CRM Integration" width={60} height={60} className="object-contain" />
								</div>
								<span className="text-sm text-gray-600 text-center">CRM Integration</span>
							</div>
							<div className="flex flex-col items-center">
								<div className="w-20 h-20 bg-white rounded-lg shadow-sm p-3 flex items-center justify-center mb-2">
									<Image src="/placeholder-icon.png" alt="Email Campaigns" width={60} height={60} className="object-contain" />
								</div>
								<span className="text-sm text-gray-600 text-center">Email Campaigns</span>
							</div>
							<div className="flex flex-col items-center">
								<div className="w-20 h-20 bg-white rounded-lg shadow-sm p-3 flex items-center justify-center mb-2">
									<Image src="/placeholder-icon.png" alt="Landing Pages" width={60} height={60} className="object-contain" />
								</div>
								<span className="text-sm text-gray-600 text-center">Landing Pages</span>
							</div>
							<div className="flex flex-col items-center">
								<div className="w-20 h-20 bg-white rounded-lg shadow-sm p-3 flex items-center justify-center mb-2">
									<Image src="/placeholder-icon.png" alt="Lead Scoring" width={60} height={60} className="object-contain" />
								</div>
								<span className="text-sm text-gray-600 text-center">Lead Scoring</span>
							</div>
							<div className="flex flex-col items-center">
								<div className="w-20 h-20 bg-white rounded-lg shadow-sm p-3 flex items-center justify-center mb-2">
